...
export default function Precache(context: CScriptPrecacheContext) {
    ...
    precacheResource(
        [
            'particles/generic_gameplay/item_received_sparkles.vpcf',
            'particles/units/lostsiren/lostsiren_feet.vpcf',
            'soundevents/treasures/metal_chest.vsndevts',
            'soundevents/breakables/wooden_chest.vsndevts',
            'soundevents/units/lostsiren.vsndevts',
            'maps/',
        ],
        context
    );
